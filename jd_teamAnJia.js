...
————————————————
入口：[组队分豆-安佳 (https://lzkjdz-isv.isvjcloud.com/pool/captain/12314?activityId=f88dd152fdc049f3b92aa58339b26345&shareUuid=a3a05d3be51b44beb279d9f72f5478b5)]
IOS等用户直接用NobyDa的jd cookie
============Quantumultx===============
[task_local]
#组队分豆-安佳
20 0,20 * * * jd_teamAnJia.js, tag=组队分豆-安佳, enabled=true
================Loon==============
[Script]
cron "20 0,20 * * *" script-path=jd_teamAnJia.js,tag=组队分豆-安佳
===============Surge=================
组队分豆-安佳 = type=cron,cronexp="20 0,20 * * *",wake-system=1,timeout=3600,script-path=jd_teamAnJia.js
============小火箭=========
组队分豆-安佳 = type=cron,script-path=jd_teamAnJia.js, cronexpr="20 0,20 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    console.log(`若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/12314?activityId=f88dd152fdc049f3b92aa58339b26345&shareUuid=a3a05d3be51b44beb279d9f72f5478b5`)
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['a3a05d3be51b44beb279d9f72f5478b5']
            $.bean = 0;
