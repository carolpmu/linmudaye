...
第一个账号助力作者 其他依次助力CK1
————————————————
入口：[ 10.23~29 大牌联合 狂欢抢先GO (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=dz20211023wkcn14cn5cnd0sdbs5sbx&shareUuid=0fadea31fbdc4eb895f036cc0e691857)]
请求太频繁会被黑ip
过10分钟再执行
============Quantumultx===============
[task_local]
#10.23~29 大牌联合 狂欢抢先GO
27 0,22 23-29 10 * jd_opencardGO2.js, tag=10.23~29 大牌联合 狂欢抢先GO, enabled=true
*/
...
!(async () => {
    ...
    console.log(`入口：\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=dz20211023wkcn14cn5cnd0sdbs5sbx&shareUuid=0fadea31fbdc4eb895f036cc0e691857`);
    
    authorCodeList = ['0fadea31fbdc4eb895f036cc0e691857']
...
async function rush() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            if ($.index==1) $.authorCode = '0fadea31fbdc4eb895f036cc0e691857'
