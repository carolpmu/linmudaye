...
[task_local]
#取关所有主播
55 6 29 * * jd_unsubscriLive.js, tag=取关所有主播, 
===========Loon============
[Script]
cron "55 6 29 * *" script-path=jd_unsubscriLive.js,tag=取关所有主播
============Surge=============
取关所有主播 = type=cron,cronexp="55 6 29 * *",wake-system=1,timeout=3600,script-path=jd_unsubscriLive.js
===========小火箭========
取关所有主播 = type=cron,script-path=jd_unsubscriLive.js, cronexpr="55 6 29 * *", timeout=3600, enable=true
 */
