...
[task_local]
#发财挖宝
6 0-23/1 * * * jd_fcwb.js, tag=发财挖宝, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "6 0-23/1 * * *" script-path=jd_fcwb.js,tag=发财挖宝
===================================Surge================================
发财挖宝 = type=cron,cronexp="6 0-23/1 * * *",wake-system=1,timeout=3600,script-path=jd_fcwb.js
====================================小火箭=============================
发财挖宝 = type=cron,script-path=jd_fcwb.js, cronexpr="6 0-23/1 * * *", timeout=3600, enable=true
 */
const $ = new Env('发财挖宝');
...
!(async () => {
    ...
    const url = `https://ghproxy.com/https://raw.githubusercontent.com/linmudaye/updateTeam/master/fcwb.json`
