...
[task_local]
#攒金币 赢大礼
22 0,8 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_GoldcoinToGift.js, tag=攒金币 赢大礼, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "22 0,8 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_GoldcoinToGift.js,tag=攒金币 赢大礼
===================================Surge================================
攒金币 赢大礼 = type=cron,cronexp="22 0,8 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_GoldcoinToGift.js
====================================小火箭=============================
攒金币 赢大礼 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_GoldcoinToGift.js, cronexpr="22 0,8 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/linmudaye/updateTeam/master/shareCodes/GoldcoinToGift.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/GoldcoinToGift.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/GoldcoinToGift.json')
  }
