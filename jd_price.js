...
[task_local]
#京东保价
41 0,12,23 * * * jd_price.js, tag=京东保价, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon==============
[Script]
cron "41 0,12,23 * * *" script-path=jd_price.js,tag=京东保价
===============Surge=================
京东保价 = type=cron,cronexp="41 0,12,23 * * *",wake-system=1,timeout=3600,script-path=jd_price.js
============小火箭=========
