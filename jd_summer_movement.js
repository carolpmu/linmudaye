/*
燃动夏季
cron 25 0,6-23/2 * * * jd_summer_movement.js
...
!(async () => {
  ...
  if(helpAuthorFlag){
    try{
      res = await getAuthorShareCode('http://cdn.839762335.xyz/392b03aabdb848d0b7e5ae499ef24e35/');
      res2 = await getAuthorShareCode(`https://cdn.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/jd_zoo.json?${new Date()}`);
    }catch (e) {}
    if(!res){res = [];}
    if(!res2){res2 = [];}
  }
