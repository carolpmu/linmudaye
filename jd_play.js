...
[task_local]
#玩一玩成就
0 8 * * * jd_play.js, tag=玩一玩成就, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_play.png, enabled=true
================Loon==============
[Script]
cron "0 8 * * *" script-path=jd_play.js,tag=玩一玩成就
===============Surge=================
玩一玩成就 = type=cron,cronexp="0 8 * * *",wake-system=1,timeout=3600,script-path=jd_play.js
============小火箭=========
玩一玩成就 = type=cron,script-path=jd_play.js, cronexpr="0 8 * * *", timeout=3600, enable=true
*/
const $ = new Env('玩一玩成就');
