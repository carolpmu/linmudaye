...
[task_local]
#东东超市兑换奖品
59 59 23 * * * jd_blueCoin.js, tag=东东超市兑换奖品, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true
...
===================Surge==================
东东超市兑换奖品 = type=cron,cronexp="59 59 23 * * *",wake-system=1,timeout=3600,script-path=jd_blueCoin.js

============小火箭=========
东东超市兑换奖品 = type=cron,script-path=jd_blueCoin.js, cronexpr="59 59 23 * * *", timeout=3600, enable=true
 */
