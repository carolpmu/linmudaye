/*
双十一无门槛红包
cron 0 0,12,18,20 * * *  jd_red11.js
* */
const $ = new Env('双11红包');
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
const flCode = $.isNode() ? (process.env.FLCODE ? process.env.FLCODE : '3LUOIt2'):'3LUOIt2';
let cookiesArr = [];
if ($.isNode()) {
...
async function main() {
    ...
    for (let i = 0; i < 10 && !$.max; i++) {
        ...
        $.actId = $.url2.match(/mall\/active\/([^/]+)\/index\.html/) && $.url2.match(/mall\/active\/([^/]+)\/index\.html/)[1] || '3ejF2Cp8CpxTX1x9mmK5prB5irqj';
