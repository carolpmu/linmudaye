...
cron 14/41 7-14 * * * https://raw.githubusercontent.com/linmudaye/scripts/master/jd_summer_movement_help.js
...
!(async () => {
  ...
  if(!$.innerShInviteList[0]){
    $.innerShInviteList = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/linmudaye/updateTeam/master/shareCodes/summer_movement.json');
  }
  if(!res2[0]){
    res2 = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/linmudaye/updateTeam/master/shareCodes/summer_movement.json');
  }
  $.ShInviteLists = []
  $.ShInviteLists = []
  if (ShHelpAuthorFlag) {
