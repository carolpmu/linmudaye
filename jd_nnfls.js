...
[task_local]
#牛牛福利
1 0,9,19,23 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_nnfls.js, tag=牛牛福利, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "1 0,9,19,23 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_nnfls.js,tag=牛牛福利
===================================Surge================================
牛牛福利 = type=cron,cronexp="1 0,9,19,23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_nnfls.js
====================================小火箭=============================
牛牛福利 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_nnfls.js, cronexpr="1 0,9,19,23 * * *", timeout=3600, enable=true
 */
const $ = new Env('牛牛福利');
