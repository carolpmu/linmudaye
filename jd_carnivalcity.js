...
[task_local]
#京东手机狂欢城
0 0-18/6 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_carnivalcity.js, tag=京东手机狂欢城, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=====================Loon================
[Script]
cron "0 0-18/6 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_carnivalcity.js, tag=京东手机狂欢城
====================Surge================
京东手机狂欢城 = type=cron,cronexp=0 0-18/6 * * *,wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_carnivalcity.js
============小火箭=========
京东手机狂欢城 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_carnivalcity.js, cronexpr="0 0-18/6 * * *", timeout=3600, enable=true
*/
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: `https://raw.githubusercontent.com/linmudaye/params/main/codes.json`, 'timeout': 20000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
