...
================Loon==============
[Script]
cron "30 1 * * *" script-path= jd_kxcdz.js,tag= 开学充电站
===============Surge=================
开学充电站 = type=cron,cronexp="30 1 * * *",wake-system=1,timeout=3600,script-path= jd_kxcdz.js
============小火箭=========
开学充电站 = type=cron,script-path= jd_kxcdz.js, cronexpr="30 1 * * *", timeout=3600, enable=true
*/
const $ = new Env('开学充电站')
