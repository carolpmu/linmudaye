...
[task_local]
#企有此礼
30 0 * * * jd_qycl.js, tag= 企有此礼
================Loon==============
[Script]
cron "30 0 * * *" script-path= jd_qycl.js,tag= 企有此礼
===============Surge=================
企有此礼 = type=cron,cronexp="30 0 * * *",wake-system=1,timeout=3600,script-path= jd_qycl.js
============小火箭=========
企有此礼 = type=cron,script-path= jd_qycl.js, cronexpr="30 0 * * *", timeout=3600, enable=true
*/
const $ = new Env('企有此礼')
