...
async function joinLeaderTuan() {
  ...
  if (!res) res = await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/linmudaye/updateTeam@master/shareCodes/jd_updateFactoryTuanId.json');
...
function updateTuanIdsCDN(url = 'https://raw.githubusercontent.com/linmudaye/updateTeam/master/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    const options = {
